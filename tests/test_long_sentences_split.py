...
def main():
    # 测试参数
    input_file = "test_long_sentences.json"
    output_file = "test_long_sentences_split_result.json"
    video_width = 358
    video_height = 512
    font_size = 16

    print("开始测试长句子根据逗号或顿号分割字幕功能...")
    ...
    try:
        ...
        for i, segment in enumerate(result):
            ...
            print(f"{i+1}. '{segment['text']}' (时间: {segment['start']:.3f}s - {segment['end']:.3f}s, 持续: {duration:.3f}s)")
